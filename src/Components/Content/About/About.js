	...
	return (
		<div className={s.about}>
			...
			<ul className='priority'>
				<li className='priority__item'>проектирование и строительство объектов мобильной связи;</li>
				<li className='priority__item'>проектирование и строительство волоконно-оптических линий связи;</li>
				<li className='priority__item'>проектирование и монтаж систем охранно-пожарной сигнализации, системы контроля и управления доступом, видеонаблюдение, структурированные кабельные системы, локальные вычислительные сети и др.</li>
			</ul>
			<p>За время нашей деятельности, нашими постоянными заказчиками стали:</p>
			<ul className='partner'>
				<li className='partner__item'>ОАО «Мобильные ТелеСистемы»</li>
				<li className='partner__item'>ОАО «ВымпелКом»</li>
				<li className='partner__item'>Группа компаний ТELE 2</li>
				<li className='partner__item'>ЗАО «Эрикссон Корпорация АО»</li>
				<li className='partner__item'>Дочерние компании ОАО «Газпром»</li>
				<li className='partner__item'>МЧС РОССИИ</li>
				<li className='partner__item'>SIEMENS (NOKIA SIEMENS NETWORKS)</li>
				<li className='partner__item'>Мобильные операторы республики Крым</li>
			</ul>
			<p>ООО «Южрегионтелеком распологается на территории общей площадью 9500 кв.м.</p>
			<div className='organizationFoto'>
				<div className='organizationFoto__item'><img src={office} /></div>
				<div className='organizationFoto__item'><img src={storage} /></div>
				<div className='organizationFoto__item'><img src={storage2} /></div>
			</div>
			<p>ООО «Южрегионтелеком» имеет все необходимые допуски и лицензии в том числе:</p>
			<ul className='licenses'>
				<li className='licenses__item'>Свидетельство СРО изыскания;</li>
				<li className='licenses__item'>Свидетельство СРО ПИР;</li>
				<li className='licenses__item'>Свидетельство СРО СМР, в том числе на уникальных объектах;</li>
				<li className='licenses__item'>Лицензия МЧС</li>
			</ul>
			<div className='licenseImg'>
				<div className='licenseImg__item'><img src={license1} /></div>
				<div className='licenseImg__item'><img src={license2} /></div>
				<div className='licenseImg__item'><img src={license3} /></div>
				<div className='licenseImg__item'><img src={license4} /></div>
			</div>
			...
			<div className='certificates'>
				<div className='certificates__item'><img src={sertificate1} /></div>
				<div className='certificates__item'><img src={sertificate2} /></div>
				<div className='certificates__item'><img src={sertificate3} /></div>
				<div className='certificates__item'><img src={sertificate4} /></div>
			</div>
			...
			<div className='technic'>
				<div className='technic__item'><img src={technic1} /></div>
				<div className='technic__item'><img src={technic2} /></div>
				<div className='technic__item'><img src={technic3} /></div>
			</div>
			...
			<div className='otherImage'>
				<div className='otherImage__item'><img src={camOnRoad} /></div>
				<div className='otherImage__item'><img src={cam} /></div>
			</div>
