...
const SmallHeader = () => {
	return (
		<div className={s.smallHeader}>
			<div className={s.smallHeader__wrapper}>
				<div className={s.smallHeader__item}><NavLink to='/about'>О компании</NavLink></div>
				<div className={s.smallHeader__item}><NavLink to='/about'>Услуги</NavLink></div>
				<div className={s.smallHeader__item}><NavLink to='/about'>Партнеры</NavLink></div>
				<div className={s.smallHeader__item}><NavLink to='/about'>Контакты</NavLink></div>
			</div>
		</div>
	)
}
...
const NavbarOnPC = () => {
	return (
		<nav className={`${s.header__nav} ${s.nav}`}>
			...
			<div className={s.nav__item}><NavLink to='/licenses'>Партнеры</NavLink></div>
			<div className={s.nav__item}><NavLink to='/certificate'>Контакты</NavLink></div>
